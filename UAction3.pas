...
procedure TAction3.DelFilesForm(Directory, Filemask: string;
  DelSubDirs: Boolean);
...
function TAction3.waktu: string;
var tgl : TDateTime;
begin
  tgl:=Now();
...
procedure TAction3.frxrprt1BeforePrint(Sender: TfrxReportComponent);
...
begin
  try
    ...
    'Gambar_scan\'+Action2.VirtualTable1.FieldValues['Image']);
    except
      ShowMessage('Objek Tidak Ditemukan');
end;
end;
procedure TAction3.FormShow(Sender: TObject);
begin
...
//procedure TAction3.btn1Click(Sender: TObject);
//var PDFku:TfrxCustomExportFilter;
//namapdf,lokasihapus : string;
//begin
//  if asalscan = 0 then
//  begin
//    namapdf := Action.Edt1.Text+'-'+Form1.Edt2.Text+'-'+waktu+'Surat-masuk.pdf';
